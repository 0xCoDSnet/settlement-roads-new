                ...
                new ConfiguredFeature<>(RoadFeature.ROAD_FEATURE,
                        new RoadFeatureConfig(
                                List.of(Blocks.DIAMOND_BLOCK.getDefaultState(), Blocks.EMERALD_BLOCK.getDefaultState(),
                                        Blocks.GOLD_BLOCK.getDefaultState(), Blocks.IRON_BLOCK.getDefaultState(), Blocks.DIRT_PATH.getDefaultState()),  // artificial
                                List.of(Blocks.COARSE_DIRT.getDefaultState(), Blocks.DIRT_PATH.getDefaultState()),                                      // natural
                                List.of(2,3,4),                                                                                                         // width
