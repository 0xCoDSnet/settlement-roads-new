    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?,?>> context){
        ...
        context.register(RoadFeature.ROAD_FEATURE_KEY,
                new ConfiguredFeature<>(RoadFeature.ROAD_FEATURE,
                        new RoadFeatureConfig(List.of(Blocks.DIAMOND_BLOCK.getDefaultState(), Blocks.GRAVEL.getDefaultState()), List.of(2,3,4,5), List.of(1,2,3,4,5,6,7,8,9), List.of(1,2)))
        );
    }
}